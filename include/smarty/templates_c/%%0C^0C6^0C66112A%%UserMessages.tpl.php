<?php /* Smarty version 2.6.14, created on 2013-11-09 02:15:41
         compiled from UserMessages.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'UserMessages.tpl', 37, false),array('modifier', 'truncate', 'UserMessages.tpl', 142, false),array('modifier', 'choptext', 'UserMessages.tpl', 145, false),)), $this); ?>
...
<div id="content">
    ...
    <div class="grey-head"><h2><?php echo $this->_tpl_vars['Application643']; ?>
</h2></div>
    <div class="row-blue">
        <p class="blue"><?php echo $this->_tpl_vars['Application644']; ?>
 <?php if ($this->_tpl_vars['user_unread_pms'] > 0): ?><b><?php endif;  echo $this->_tpl_vars['user_unread_pms']; ?>
 <?php echo $this->_tpl_vars['Application645']; ?>
 <?php if ($this->_tpl_vars['user_unread_pms'] > 0): ?></b><?php endif;  echo $this->_tpl_vars['Application646']; ?>
</p>

                <?php if ($this->_tpl_vars['maxpage'] > 1): ?>
        <p class="blue">
            <?php if ($this->_tpl_vars['p'] != 1): ?><a href='UserMessages.php?p=<?php echo smarty_function_math(array('equation' => 'p-1','p' => $this->_tpl_vars['p']), $this);?>
'>&#171; <?php echo $this->_tpl_vars['Application649']; ?>
</a><?php else: ?><font class='disabled'>&#171; <?php echo $this->_tpl_vars['Application649']; ?>
</font><?php endif; ?>
            <?php if ($this->_tpl_vars['p_start'] == $this->_tpl_vars['p_end']): ?>
            &nbsp;|&nbsp; <?php echo $this->_tpl_vars['Application650']; ?>
 <?php echo $this->_tpl_vars['p_start']; ?>
 <?php echo $this->_tpl_vars['Application652']; ?>
 <?php echo $this->_tpl_vars['total_pms']; ?>
 &nbsp;|&nbsp;
            <?php else: ?>
            &nbsp;|&nbsp; <?php echo $this->_tpl_vars['Application651']; ?>
 <?php echo $this->_tpl_vars['p_start']; ?>
-<?php echo $this->_tpl_vars['p_end']; ?>
 ...
 &nbsp;|&nbsp;
            <?php endif; ?>
            <?php if ($this->_tpl_vars['p'] != $this->_tpl_vars['maxpage']): ?><a href='UserMessages.php?p=<?php echo smarty_function_math(array('equation' => 'p+1','p' => $this->_tpl_vars['p']), $this);?>
'><?php echo $this->_tpl_vars['Application653']; ?>
 &#187;</a><?php else: ?><font class='disabled'><?php echo $this->_tpl_vars['Application653']; ?>
 &#187;</font><?php endif; ?>
        </p>
        <?php endif; ?>
...
<?php endif; ?>
        ...
        <div id="ajaxContainer">
            ...
            <p style="padding-left:25px;"><?php echo $this->_tpl_vars['Application654']; ?>
</p>
            <br/>
            ...
            <div id="primary" class="info-cnt tuneddivs" style="color:#666666;">
                <form action='UserMessages.php' method='post' name='messageform' class="settings">
...
?>
                    ...
                    <?php endif; ?>
                         ...
                         <div class="f-right" style="padding-right: 35px">
                            <a href='UserMessagesNew.php?pm_id=<?php echo $this->_tpl_vars['pms'][$this->_sections['pm_loop']['index']]['pm_id']; ?>
'><?php echo $this->_tpl_vars['Application659']; ?>
</a><br/>
...
' value='1' style="margin:0; height:15px; width:15px;"/>
                        </div>
...
'><?php echo ((is_array($_tmp=$this->_tpl_vars['pms'][$this->_sections['pm_loop']['index']]['pm_subject'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : smarty_modifier_truncate($_tmp, 50)); ?>
                    ...
                    <p align="right">select all &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="select_all" onClick="javascript:doCheckAll()" style="height:15px; width:15px;"/></p>
                    ...
                    <div class="f-left">
                        ...
                        <a class="button" href="UserMessagesNew.php"><span><?php echo $this->_tpl_vars['Application647']; ?>
                                                ...
                                                <?php if ($this->_tpl_vars['total_pms'] != 0): ?>
                        <a class="button" href="javascript:void(0)" onclick="document.messageform.submit();"><span><?php echo $this->_tpl_vars['Application661']; ?>
</span></a>
