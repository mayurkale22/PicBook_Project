...
switch($s) {
  ...
  case "t": $sort = "friends.friend_type"; $t = "td"; break;
  default: $sort = "phps_users.user_dateupdated DESC"; $u = "ud";
}

if($search != "") { $is_where = 1; $where = "(phps_users.user_username LIKE '%$search%' OR phps_users.user_email LIKE '%$search%')"; } else { $is_where = 0; $where = ""; }
